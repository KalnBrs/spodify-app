  ...
  return (
    <div className='container'>
      <div onClick='' className='playlistContainer'>
        ...
        <img src="src/assets/person.svg" alt="" className='playlistPerson'/>
      </div>
      <div>
        <p className='playlistTime'>98:00 - 98 tracks</p>
        <div className='playlistButtons'>
          <button className='playlistIcons edit'>
            <img src="src/assets/edit.svg" alt="" className='playlistIcons edit'/>
          </button>
          <button className='playlistIcons trash'>
            <img src="src/assets/trash.svg" alt="" className='playlistIcons trash'/>
          </button>
        </div>
      </div>
    </div>
